...
from wagtail_pdf_view.modeladmin.mixins import PdfViewButtonHelper, ModelAdminPdfViewMixin, ModelAdminPdfAdminViewMixin

class MyCustomButtonHelper(PdfViewButtonHelper):
    
    custom_object_buttons = PdfViewButtonHelper.custom_object_buttons + [
...
class DemoModelWagtailAdmin(ModelAdminPdfViewMixin, ModelAdminPdfAdminViewMixin, ModelAdmin):
    ...
    def get_custom_object_views(self):
        return super().get_custom_object_views() + [
